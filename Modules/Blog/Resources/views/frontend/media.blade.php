...
@section('title', $blog->translate(locale())->title)
@section('content')

<section class="page-head align-items-center text-center d-flex">
    <div class="container">
        <h1>{{ $blog->translate(locale())->title }}</h1>
        <ul class="mt-20">
            <li>
            ...
            <li>
                <a href="{{ url(route('frontend.blogs.media_center')) }}">
                    {{ __('blog::frontend.media_center.title') }} /
                </a>
            </li>
            <li class="active">{{ $blog->translate(locale())->title }}</li>
        </ul>
    </div>
</section>
...
<div class="inner-page">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="blog-details">
                    ...
                    <img class="img-fluid" src="{{ url($blog->image) }}" alt="IMG">
                    <p>
                        {!! $blog->translate(locale())->description !!}
                    </p>
                </div>

                {{-- <div class="post-comments blog-author blog-written-by">
                    <h5>2 {{ __('blog::frontend.index.comments') }}</h5>
                    <div class="comments-replies border-bottom pb-6 mb-6">
                        <div class="comment-box">
                            <div class="media align-items-center">
                                <div class="comment-avatar">
                                    <img class="img-fluid rounded-circle" src="/frontend/en/images/blog/author-3.jpg" alt="Image Description">
                                </div>
                                <div class="media-body">
            ...
            {{-- <div class="col-md-4 blog-side-container">
                            ...
                            <article>
                                <div class="row justify-content-between">
                                    <div class="col-7 pr-0">
                                        ...
                                        <h4 class="mb-0">
                                            <a href="index.php?page=blog-post">Enjoy $1,000 worth with Front for Business</a>
                                        </h4>
                                    </div>

                                    <div class="col-5">
                                        <img class="img-fluid" src="/frontend/en/images/blog/img-1.jpg" alt="Image Description">
                                    </div>
                                </div>
                            </article>
                            <article>
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5">
                                        <img class="img-fluid" src="/frontend/en/images/blog/img-2.jpg" alt="Image Description">
                                    </div>
                                </div>
                            </article>
                            <article>
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5">
                                        <img class="img-fluid" src="/frontend/en/images/blog/img-3.jpg" alt="Image Description">
                                    </div>
                                </div>
                            </article>
                        </div>
        ...
        {{-- <div class="res-blog-side align-items-center mt-20">
                <span><i class="ti-layout-list-thumb"></i> Blog Options</span>
