...
@section('title', __('apps::dashboard.subscribe.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('apps::dashboard.subscribe.routes.index')}}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('apps::dashboard.subscribe.routes.index')}}
                            </span>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('apps::dashboard.subscribe.datatable.email')}}</th>
                                    <th>{{__('apps::dashboard.subscribe.datatable.created_at')}}</th>
                                    <th>{{__('apps::dashboard.subscribe.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('apps::dashboard.subscribe.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            responsivePriority:1,
                            render: function (data, type, full, meta) {
