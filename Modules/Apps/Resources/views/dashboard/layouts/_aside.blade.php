<div class="page-sidebar-wrapper">
  ...
  <div class="page-sidebar navbar-collapse collapse">
    <ul class="page-sidebar-menu  page-header-fixed"
      ...
      @endcan --}}
      @canany( $usersPermissions= ['show_users','show_admins','show_trainers','show_memberships'] )
      <li class="nav-item  active open {{active_slide_menu($usersPermissions)}}">
        <a href="javascript:;"
          class="nav-link nav-toggle">
      ...
      {{-- @canany(['show_exams','show_questions','show_userexams'])
      <li class="nav-item  {{active_slide_menu(['exams','questions','userexams'])}}">
        <a href="javascript:;"
          class="nav-link nav-toggle">
          <i class="icon-pointer"></i>
        ...
        <ul class="sub-menu">
          ...
          <li class="nav-item {{ active_menu('userexams') }}">
            <a href="{{ route('dashboard.userexams.index') }}"
              class="nav-link nav-toggle">
              <i class="fa fa-building"></i>
              <span class="title">{{ __('apps::dashboard._layout.aside.userexams') }}</span>
              <span class="selected"></span>
            </a>
          </li>
        </ul>
      ...
      @canany($coursesPermissions=['show_courses','show_meetings',
      'show_lessons','show_lessoncontents','show_coursereviews'])


      <li class="nav-item active open  {{active_slide_menu($coursesPermissions)}}">
        <a href="javascript:;"
          class="nav-link nav-toggle">
          <i class="icon-pointer"></i>
          ...
          <span class="arrow {{
                        active_slide_menu(
                            ['courses','lessons','lessoncontents','meetings','show_coursereviews']
                            )}}"></span>
        ...
        <ul class="sub-menu">
          ...
          <li class="nav-item {{ active_menu('lessoncontents') }}">
            <a href="{{ route('dashboard.lessoncontents.index') }}"
              class="nav-link nav-toggle">
              <i class="fa fa-building"></i>
          ...
          <li class="nav-item {{ active_menu('coursereviews') }}">
            <a href="{{ route('dashboard.coursereviews.index') }}"
              class="nav-link nav-toggle">
              <i class="fa fa-building"></i>
      ...
      <li class="nav-item {{ active_menu('orders') == 'active' && request('status_id') ? 'active' : '' }}">
        <a href="{{ url(route('dashboard.orders.index' , ['status_id'=>'1'])) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
      ...
      {{-- @can('show_threads')
      <li class="nav-item {{ active_menu('threads') }}">
        <a href="{{ url(route('dashboard.threads.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
          <span class="title">{{ __('apps::dashboard._layout.aside.threads') }}</span>
        </a>
      </li>
      @endcan --}}
      ...
      @endcan
      @can('show_reviewquestions')
      <li class="nav-item {{ active_menu('reviewquestions') }}">
        <a href="{{ url(route('dashboard.reviewquestions.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
          <span class="title">{{ __('apps::dashboard._layout.aside.reviewquestions') }}</span>
        </a>
      </li>
      @endcan
      ...
      {{-- @can('show_applies')
      <li class="nav-item {{ active_menu('show_applies') }}">
        <a href="{{ url(route('dashboard.applies.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
          <span class="title">{{ __('apps::dashboard._layout.aside.trainers_applies') }}</span>
        </a>
      </li>
      @endcan --}}
      {{-- @can('show_serviceapplies')
      <li class="nav-item {{ active_menu('show_serviceapplies') }}">
        <a href="{{ url(route('dashboard.serviceapplies.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
          <span class="title">{{ __('apps::dashboard._layout.aside.serviceapplies') }}</span>
        </a>
      </li>
      @endcan --}}
      ...
      <li class="nav-item  {{active_slide_menu(['homepagesections','homepagesectiontypes'])}}">
        <a href="javascript:;"
          class="nav-link nav-toggle">
          <i class="icon-pointer"></i>
          <span class="title">{{ __('apps::dashboard._layout.aside.homepagesections') }}</span>
        ...
        <ul class="sub-menu">
          ...
          <li class="nav-item {{ active_menu('homepagesections') }}">
            <a href="{{ url(route('dashboard.homepagesections.index')) }}"
              class="nav-link nav-toggle">
              <i class="fa fa-building"></i>
      ...
      <li class="nav-item {{ active_menu('subscribe') }}">
        <a href="{{ url(route('dashboard.subscribe.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
      ...
      <li class="nav-item {{ active_menu('testimonials') }}">
        <a href="{{ url(route('dashboard.testimonials.index')) }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
      ...
      <li class="nav-item {{ active_menu('app-homes') }}">
        <a href="{{ url(route('dashboard.apphomes.index')) }}"
          ...
          <i class="icon-settings"></i>
          <span class="title">
            {{ __('apps::dashboard._layout.aside.homepagesections') }}
          </span>
          <span class="selected"></span>
        </a>
      </li>
      ...
      <li class="nav-item {{ active_menu('themes') }}">
        <a href="{{ route('developer.themes.colors.index') }}"
          class="nav-link nav-toggle">
          <i class="icon-settings"></i>
