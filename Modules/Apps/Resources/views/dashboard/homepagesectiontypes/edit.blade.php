...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                    {!! Form::model($model,[
                        'url'=> route('dashboard.homepagesectiontypes.update',$model->key),
                        'id'=>'updateForm',
                        'role'=>'form',
                        'method'=>'PUT',
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                <li class="active">
                                                    <a href="#global_setting" data-toggle="tab">
                                                        {{ __('apps::dashboard.homepagesectiontypes.form.tabs.general') }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    <div class="col-md-10">
                                @include('apps::dashboard.homepagesectiontypes.forms.form')
                                    </div>
                                </div>
                                {{-- PAGE ACTION --}}
                                <div class="col-md-12">
