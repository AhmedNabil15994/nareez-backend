...
class AdminController extends Controller
{
    ...
    {
        $this->view_path='user::dashboard.admins';
        $this->role = $role;
        $this->admin = $admin;
    }
    ...
    public function create()
    {
        ...
        $model=new  User();
        return view('user::dashboard.admins.create', compact('roles', 'model'));
    }
    ...
    {
        $model = $this->admin->findById($id);
        $roles = $this->role->getAllAdminsRoles('id', 'asc');

        return view('user::dashboard.admins.edit', compact('model', 'roles'));
    }
