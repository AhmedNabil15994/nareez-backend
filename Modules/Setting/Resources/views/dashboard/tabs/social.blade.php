  ...
  <div class="form-body">
    ...
    <div class="col-md-10">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" name="social[snapchat]"
            value="{{ setting('social', 'snapchat') }}" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-2">
          {{ __('setting::dashboard.settings.form.Whatsapp') }}
        </label>
        <div class="col-md-9">
          <input type="text" class="form-control" name="social[Whatsapp]"
            value="{{ setting('social', 'Whatsapp') }}" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-2">
          {{ __('setting::dashboard.settings.form.ksa_whatsapp') }}
        </label>
        <div class="col-md-9">
          <input type="text" class="form-control" name="social[ksa_whatsapp]"
            value="{{ setting('social', 'ksa_whatsapp') }}" />
        </div>
      </div>
    </div>
  </div>
