<div class="tab-pane fade" id="other">
  ...
  <div class="col-md-10">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
        <select name="other[about_us]" id="single" class="form-control ">
          <option value=""></option>
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
        <select name="other[privacy_policy]" id="single" class="form-control ">
          <option value=""></option>
          @foreach ($pages as $page)
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
        <select name="other[terms]" id="single" class="form-control ">
          <option value=""></option>
          @foreach ($pages as $page)
    ...
    <div class="form-group">
      <label class="col-md-2">
        {{ __('setting::dashboard.settings.form.faqs') }}
      </label>
      <div class="col-md-9">
        <select name="other[faqs]" class="form-control ">
          <option value=""></option>
          @foreach ($pages as $page)
          <option value="{{ $page['id'] }}" {{(setting('other','faqs')==$page->id) ? ' selected="" ' : ''}}>
            {{ $page->title }}
          </option>
          @endforeach
        </select>
