@if (is_rtl() == 'rtl')
    <script src="{{ asset('admin/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-rtl.min.js') }}"
            type="text/javascript">
    </script>
@else
    <script src="{{ asset('admin/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js') }}" type="text/javascript">
    </script>
@endif
