  ...
  <div class="page-content">
    ...
    <div class="row">
      <form id="updateForm"
        ...
        action="{{route('developer.themes.colors.update')}}">
        @csrf
        @method('PUT')
        <div class="col-md-12">
                  ...
                  <div class="col-lg-6 col-md-12">
                    <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title"
                        ...
                        {!! field()->checkBox($content['key'],
                        '',null,
                        [setting($content['key'])? 'checked' : '' => ''])
                            ...
                            <div class="col-lg-9">
                              ...
                              <a class="list-toggle-container"
                                ...
                                <div class="list-toggle uppercase color_view"
                                  ...
                                  {{isset($colors_values[$color['var_name']]) ? $colors_values[$color['var_name']] :
                                  '#e8e5ef00'}}
                                </div>
                              </a>
                              @endif
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button"
          class="btn green"
          id="save_color_btn">Save changes</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
