...
namespace Modules\DeveloperTools\Http\Controllers\Dashboard\Themes;
...
class ColorController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        file_put_contents(
            module_path('DeveloperTools', 'site_colors.json'),
            json_decode(json_encode($build_colors['config']), false)
        );
