...
@section('title', __('catalog::dashboard.clients.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('catalog::dashboard.clients.routes.index')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::dashboard.clients.datatable.trainer')}}</th>
                                    <th>{{__('catalog::dashboard.clients.datatable.status')}}</th>
                                    <th>{{__('catalog::dashboard.clients.datatable.created_at')}}</th>
                                    <th>{{__('catalog::dashboard.clients.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
responsivePriority:1,
                            width: '13%',
                            title: '{{__('catalog::dashboard.clients.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.clients.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.clients.destroy", ":id") }}';
